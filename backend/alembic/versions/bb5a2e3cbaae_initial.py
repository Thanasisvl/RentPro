...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role", sa.Enum("ADMIN", "OWNER", "USER", name="userrole"), nullable=False
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_index(
        op.f("ix_preference_profiles_id"), "preference_profiles", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_preference_profiles_user_id"),
        "preference_profiles",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_contracts_property_id"), "contracts", ["property_id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["criterion_a_id"], ["criteria.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["criterion_b_id"], ["criteria.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["profile_id"], ["preference_profiles.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "profile_id",
    ...
    op.create_index(
        op.f("ix_pairwise_comparisons_criterion_a_id"),
        "pairwise_comparisons",
        ["criterion_a_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pairwise_comparisons_criterion_b_id"),
        "pairwise_comparisons",
        ["criterion_b_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pairwise_comparisons_id"), "pairwise_comparisons", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_pairwise_comparisons_profile_id"),
        "pairwise_comparisons",
        ["profile_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_property_location_features_property_id"),
        "property_location_features",
        ["property_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_property_location_features_property_id"),
        table_name="property_location_features",
    )
    op.drop_table("property_location_features")
    op.drop_index(
        op.f("ix_pairwise_comparisons_profile_id"), table_name="pairwise_comparisons"
    )
    op.drop_index(op.f("ix_pairwise_comparisons_id"), table_name="pairwise_comparisons")
    op.drop_index(
        op.f("ix_pairwise_comparisons_criterion_b_id"),
        table_name="pairwise_comparisons",
    )
    op.drop_index(
        op.f("ix_pairwise_comparisons_criterion_a_id"),
        table_name="pairwise_comparisons",
    ...
    op.drop_index(
        op.f("ix_preference_profiles_user_id"), table_name="preference_profiles"
    )
