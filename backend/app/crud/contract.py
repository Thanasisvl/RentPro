...
def create_contract(db: Session, contract: ContractCreate, *, created_by_id: int | None = None):
...
def update_contract(db: Session, contract_id: int, contract: ContractUpdate, *, updated_by_id: int | None = None):
