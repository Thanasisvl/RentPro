...
ACCESS_TOKEN_EXPIRE_MINUTES_DEFAULT = int(
...
def create_access_token(
    ...
    if expires_delta is None:
        minutes = int(
            os.getenv(
                "ACCESS_TOKEN_EXPIRE_MINUTES", str(ACCESS_TOKEN_EXPIRE_MINUTES_DEFAULT)
            )
        )
...
def create_refresh_token(
    ...
    if expires_delta is None:
        days = int(
            os.getenv(
                "REFRESH_TOKEN_EXPIRE_DAYS", str(REFRESH_TOKEN_EXPIRE_DAYS_DEFAULT)
            )
        )
